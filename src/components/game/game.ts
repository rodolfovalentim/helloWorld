...
export class GameComponent {
  ...
  ngAfterViewInit() {
    ...
    console.log(document.getElementById("column-player-1").clientWidth)
    ...
    this.stage.canvas.width = document.getElementById("column-player-1").clientWidth - 10
